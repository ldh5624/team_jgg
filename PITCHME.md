...
|아이디어도출|아이디어를 자유롭게 발산하는 과정|마인드맵: 문제해결을 위한 변수를 고려한 아이디어 도출 |
|||브레인라이팅: 마인드맵에서 도출된 대표 아이디어 중 3개의 아이디어를 선정 해, 아이디어를 발전 시키는 방법|
|||아이디어보드: 아이디어를 구체화 하고 시각화 하는 도구로 핵심 요소 표현, 컨셉 스케치를 통해 효과를 직관적으로 볼수 있다.|
